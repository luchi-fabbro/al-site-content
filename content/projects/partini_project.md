...
<div style="display: flex; gap: 1rem; margin-top: 1.5rem; margin-bottom: 1.5rem; flex-wrap: wrap; align-items: center;">
  <img src="https://cdn.datanut.net/assets/images/partini-main.png" alt="Partini" style="border-radius: 4px; min-width: 200px; flex: 2; width: 60%;" />
  <img src="https://cdn.datanut.net/assets/images/Partini-Stain-LRG-Trans.jpg" alt="Partini logo" style="border-radius: 4px; min-width: 160px; flex: 1; width: 35%;" />
</div>
...
<img src="https://cdn.datanut.net/assets/images/IMG_0243.jpg" alt="Partini event" width="100%" style="border-radius: 4px; margin: 1rem 0;" />
...
<div style="display: flex; gap: 1rem; margin-top: 1.5rem; flex-wrap: wrap;">
  <img src="https://cdn.datanut.net/assets/images/img_01.png" alt="Partini event styling" style="border-radius: 4px; min-width: 200px; flex: 1; width: 48%;" />
  <img src="https://cdn.datanut.net/assets/images/img_02.png" alt="Partini event detail" style="border-radius: 4px; min-width: 200px; flex: 1; width: 48%;" />
</div>
